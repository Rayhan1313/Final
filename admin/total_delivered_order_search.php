                            ...
                            <div class="col-lg-12 card bg-transparent">
                                            ...
                                            <div class="card container-fluid bg-transparent">
                                                    ...
                                                    if(!isset($_GET['source'])){
                                                                ...
                                                                $rul ="SELECT * FROM confirm_order WHERE  order_status='delivered' ";
...
*/
                                                                ...
                                                                if($numberta=mysqli_num_rows($iko) > 0) { ?>
                                                                    ...
                                                                    <?php   
                                                                        ...
                                                                        <hr>
                                                                            ...
                                                                            <?php   $queryyy = "SELECT SUM(total_money) AS total_taka FROM confirm_order WHERE  order_status='delivered' ";
                                    ...
                                    switch($source){
                                        ...
                                        default ;
                                        include "./total_delivered_order_search.php" ;
                                    }
                                    } }?>                                   
