    ...
    <div id="wrapper" class="background ">
        ...
        <div id="page-wrapper" class="background">
                ...
                <div class="container-fluid bg-transparent border mb-3">
                        ...
                        <!-- Page Heading -->
                        <div class="row bg-transparent ml-1 mr-1 mt-1 mb-1">
                            <div class="col-lg-12 card mb-4 bg-transparent "> 
                                    <ol class="breadcrumb pl-auto bg-transparent mt-3 mb-3">
                                        <li><a class="text-dark" href="./index.php"><i class="fab fa-ubuntu"> System</i></a></li>
                                        <li><a class="text-dark" href="./current_order_details.php"><i class="fa-solid fa-hourglass-start"> <small> Pending Orders</small></i> </a></li>
                                ...
                                <br>
                                            ...
                                            <?php 
                                                ...
                                                switch($source){
                                                    ...
                                                    default ;
                                                    include "./admin_page/view_current_order.php" ;
                                                }
                                            ?>
