                            ...
                            <div class="col-lg-12 card bg-transparent">
                                            ...
                                            <div class="card container-fluid bg-transparent">
                                                                                <ol class="breadcrumb pl-auto bg-transparent mt-3">
                                                                                    ...
                                                                                    <li><a class="text-dark" href="./total_processed_order_by_moderator.php"><i class="fa-solid fa-plate-wheat">    <small> Completed Orders By You </small> </i> </a></li>
                                                    ...
                                                    if(!isset($_GET['source'])){
                                                                ...
                                                                $rul ="SELECT * FROM confirm_order WHERE  order_status='delivered' AND order_processed_by='".$_SESSION['user_id']."' ";
                                                                $rul .="AND order_date BETWEEN '$from_date' AND '$to_date' ";
                                                               // }
                                                             /*  else if(($from_date =='') && ($to_date !=='')) {        
                                                                    $rul ="SELECT * FROM confirm_order WHERE  order_status='delivered' AND order_processed_by='".$_SESSION['user_id']."' ";
                                                                    $rul .="AND order_date=$to_date'";
                                                                    }
                                                                    else if(($from_date !=='') && ($to_date =='')) {        
                                                                        $rul ="SELECT * FROM confirm_order WHERE  order_status='delivered' AND order_processed_by='".$_SESSION['user_id']."' ";
                                                                        $rul .="AND order_date=$from_date'";
                                                                        }

                                                                        else if(($from_date =='') && ($to_date =='')){
                                                                            header("Location: total_processed_order_by_moderator.php");
                                                                        }
...
*/
                                                                ...
                                                                if($numberta=mysqli_num_rows($iko) > 0) { ?>
                                                                
                                                                                <h5 class="text-center">Completed Orders By You(<?php echo $numberta ; ?>)</h5>   
                                                                                <div class="card bg-transparent ml-5 pl-5 mr-5">
                                                                                
                                                                                        <div class="card-body ml-5 pl-5 mr-5">
                                                                                        
                                                                                            <form action="total_processed_order_by_moderator_search.php" method="GET" class="form ml-5 pl-5">
                                                                                                <div class="row">
                                                                                                    <div class="col-md-4">
                                                                    ...
                                                                    <?php   
                                                                        ...
                                                                        echo "<td class=' mt-5 pt-3'><a class='mt-3 btn btn-warning btn-lg' href='./total_processed_order_by_moderator.php?source=view_details&order_code={$oorder_code}'><i class='fa-solid fa-eye'> </i> View</a></td>";
                                                                        ...
                                                                        <hr>
                                                                            ...
                                                                            <?php   $queryyy = "SELECT SUM(total_money) AS total_taka FROM confirm_order WHERE  order_status='delivered' AND order_processed_by='".$_SESSION['user_id']."' ";
                                                                                    $queryyy .="AND order_date BETWEEN '$from_date' AND '$to_date'";
                                    ...
                                    switch($source){
                                        ...
                                        default ;
                                        include "./total_processed_order_by_moderator_search.php" ;
                                    }
                                    } }?>                                   
