                            ...
                            <div class="col-lg-12 card bg-transparent">
                                            ...
                                            <div class="card container-fluid bg-transparent">
                                                    ...
                                                    if(!isset($_GET['source'])){
                                                                ...
                                                                $rul ="SELECT * FROM confirm_order WHERE  order_code='$order_idd' ORDER BY confirm_order_id ASC";
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        <div class="col-md-4">
                                                                                                            <div class="form-group">
                                                                                                                ...
                                                                                                                <input type="text" name="order_code" value="<?php echo isset($_GET['order_code'])? $_GET['order_code'] : '';  ?>" class="form-control"  required>
                                                                                                            </div>
                                                                                                        </div>
                                    ...
                                    switch($source){
                                        ...
                                        default ;
                                        include "./search_by_order_id.php" ;
                                    }
                                    } ?>                                   
