...
function make_slides($connect)
{
 ...
 while($row = mysqli_fetch_array($result))
 {
  ...
  $output.=       
                  '<img class="d-block w-100 rounded  img-fluid" src="./include/item_img/'.$row["item_image"].'" alt="'.$row["item_name"].'">
...
<?php INCLUDE "./include/header.php" ; 
 ...
 <br>
 <div class="container-fluid   background  rounded-bottom rounded-left rounded-right mb-1 mt-2 pt-1 pl-2  mr-1">
            <div class="container-fluid row  pl-1  pt-1  mt-3 mb-3 mb-2 ml-1 bg-transparent rounded-top rounded-bottom rounded-left rounded-right">
            ...
            <hr>
                  ...
                  <div class="container-fluid bg-transparent ">
                      <img class="img-fluid ml-3" height="120" width="700" src="./img/YOOO.png" alt="pic">
                                          ...
                                          <br>
                        <h4 class="text-right font-italic ml-5 okk">Eat good foods and be healthy</h4>
                  </div>
                  ...
                  <div class="container-fluid ml-5 pl-5">
                      <img class="img-fluid float-right ml-5 pl-5" height="120" width="700" src="./img/juice.png" alt="pic">
                ...
                <style>
                  ...
                  <div class="container-fluid  mb-3  bg-transparent ml-5 bg-transparent edit-kori">
                             <div class="container-fluid row mt-3 mb-5  bg-transparent ml-2"> <style>
                              ...
                              <div id="carouselExampleIndicators" class="carousel slide bg-transparent" data-ride="carousel">
                                    <h4 class="text-center  font-weight-bolder  carosol-heading-color pb-2 pt-3 okay bg-transparent pb-3"><b class="">{   RT hii5 Offer !!!  }</b></h4>
